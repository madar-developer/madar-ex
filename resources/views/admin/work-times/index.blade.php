...
@section('header')
    <div class="add-btn">
        <a href="{{ url('/dashboard/worktimes/create') }}" type="button"
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> {{$item->time_to}} </td>
                                        <td class="btns">
                                            <a href="/dashboard/worktimes/{{$item->id}}/edit" type="button"
                                                class="btn btn-info   waves-effect waves-light m-b-5 btn-xs"> <i
                                                    class="fa fa-pencil"></i> تعديل </a>
                                            <a href="{{route('worktimes.destroy',$item)}}" id="delete-btn" type="button"
