                                ...
                                <div class="panel panel-default margin-top-20">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <!-- <div class="form-group margin-top-15">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::url("setting[pinterest]",(isset($setting['pinterest']))? $setting['pinterest'] : null,['class'=>'form-control'])!!}
                                            </div>          
                                        </div>
                                        <div class="form-group margin-top-15">
                                            <label class="control-label col-md-3">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::url("setting[vimeo]",(isset($setting['vimeo']))? $setting['vimeo'] : null,['class'=>'form-control'])!!}
                                            </div>          
                                        </div> -->
                                        ...
                                        <div class="form-group margin-top-15">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::textarea("setting[privacy_ar]",(isset($setting['privacy_ar']))? $setting['privacy_ar'] : null,['class'=>'form-control', 'style' => 'width: 100%; height: 150px; border: 1px solid #E3E3E3;border-radius: 4px;color: #565656;padding: 7px 12px;'])!!}
                                            </div>          
                                        </div>
                                        ...
                                        <div class="form-group margin-top-15">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::textarea("setting[about_ar]",(isset($setting['about_ar']))? $setting['about_ar'] : null,['class'=>'form-control', 'style' => 'width: 100%; height: 150px; border: 1px solid #E3E3E3;border-radius: 4px;color: #565656;padding: 7px 12px;'])!!}
                                            </div>          
                                        </div>
                                        <div class="form-group margin-top-15">
                                            <label class="control-label col-md-3">
                                        ...
                                        <div class="form-group margin-top-15">
                                            <label class="control-label col-md-3">
                                                القواعد و الاحكام  (AR)            
                                            </label>
                                            <div class="col-md-7">
                                                {!! Form::textarea("setting[terms_ar]",(isset($setting['terms_ar']))? $setting['terms_ar'] : null,['class'=>'form-control', 'style' => 'width: 100%; height: 150px; border: 1px solid #E3E3E3;border-radius: 4px;color: #565656;padding: 7px 12px;'])!!}
                                            </div>          
                                        </div>
                                        <div class="form-group margin-top-15">
                                            <label class="control-label col-md-3">
                                                القواعد و الاحكام  (EN)            
                                            </label>
                                            <div class="col-md-7">
                                                {!! Form::textarea("setting[terms_en]",(isset($setting['terms_en']))? $setting['terms_en'] : null,['class'=>'form-control', 'style' => 'width: 100%; height: 150px; border: 1px solid #E3E3E3;border-radius: 4px;color: #565656;padding: 7px 12px;'])!!}
                                            </div>          
                                        </div>
                                        <div class="form-group margin-top-15">
                                            <label class="control-label col-md-3">
                                                      التكلفة الاضافية door to door         
                                            </label>
                                            <div class="col-md-7">
                                                {!! Form::number("setting[additional_price]",(isset($setting['additional_price']))? $setting['additional_price'] : null,['class'=>'form-control'])!!}
                                            </div>          
                                        </div>
