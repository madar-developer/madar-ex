                                ...
                                <div class="panel panel-default margin-top-20">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group margin-top-15">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" name="name" class="form-control" placeholder="أدخل الاسم هنا">
                                            </div>          
                                        </div>
                            ...
                            <table class="datatable-buttons table table-striped table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$item->id}}</td>
                                        <td> {{$item->name}} </td>
                                        <td> <a href="#" data-route="{{url('/dashboard/settings/years-update/'.$item->id)}}" data-name="{{ $item->name }}" data-id="{{$item->id}}" class="edit"><i class="fa fa-pencil m-r-10" style="color: #5b69bc;"></i> تعديل</a></td>
                                        <td> 
                                            <a href="{{url('/dashboard/settings/years-delete/'.$item->id)}}" id="delete-btn" ><i class="fa fa-trash-o m-r-10" style="color: #5b69bc;"></i> حذف</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
