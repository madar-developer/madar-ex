                                                    ...
                                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>{{$item->sort}} </td>
                                                                  <td>
                                                                    <img src="{{getImage($item->image)}}" style="height: 100px; width:100px;">
                                                                  </td>
                                                                  <td>{{$item->name}} </td>
                                                                  <td>{{$item->details}} </td>
                                                                  <td> <button class="btn" style="background-color: {{$item->color}}"> {{$item->color}} </button> </td>
                                                                <td class="btns">

                                                                        <a href="/dashboard/order-status/{{$item->id}}/edit" type="button" class="btn btn-info   waves-effect waves-light m-b-5 btn-xs"> <i class="fa fa-pencil"></i> تعديل </a>

                                                                    </td>


                                                                {{--  <td>
                                                                    <a href="/dashboard/order-statuss/{{$item->id}}/edit">
                                                                        <i class="fa fa-pencil  m-r-10" style="color: #188ae2;">
                                                                        </i> تعديل</a>
                                                                </td>  --}}

                                                                {{--  <td>
                                                                     <a href="{{route('order-statuss.destroy',$item)}}" id="delete-btn"  >
