...
<div class="row">
    {{--  /////////////////////////////////  --}}
                {!!Form::model($company_order , ['url' => ['/company/company-orders/'.$company_order->id] , 'method' => 'PATCH','files'=>true]) !!}
...
<script type="text/javascript" src="https://maps.google.com/maps/api/js?sensor=false&libraries=places&key=AIzaSyASV6ryM8d7tfsgxEULmT9j3GIqEM0O7rY&language=ar"></script>
    <script type="text/javascript">
        ...
        function initialize() {
            var latLng = new google.maps.LatLng(parseFloat('{{$company_order->latitude ?? "0.000"}}'), parseFloat('{{$company_order->longitude ?? "0.000"}}'));
