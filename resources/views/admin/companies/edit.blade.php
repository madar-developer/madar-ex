...
<div class="row">
    {{--  /////////////////////////////////  --}}
                {!!Form::model($company , ['url' => ['/dashboard/companies/'.$company->id] , 'method' => 'PATCH','files'=>true]) !!}
...
<script type="text/javascript" src="https://maps.google.com/maps/api/js?sensor=false&libraries=places&key=AIzaSyASV6ryM8d7tfsgxEULmT9j3GIqEM0O7rY&language=ar"></script>
    <script type="text/javascript">
        ...
        function initialize() {
            var latLng = new google.maps.LatLng(parseFloat('{{$company->latitude ?? "0.000"}}'), parseFloat('{{$company->longitude ?? "0.000"}}'));
