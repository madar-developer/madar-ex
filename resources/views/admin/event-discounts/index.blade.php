                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="title-page sub-header-title-custom">
                            <h5 style="color: inherit;"><a href="#"><span> خصومات المناسبات </span><i class="fa fa-angle-left" style="padding: 0 5px; color:inherit;"></i></a><span>نطره عامة        </span></h5>

                            <ul>


                                <li class="offer-2">
                                    <a href="{{url('/dashboard/event-discounts/create')}}"><span><i class="fa fa-plus" aria-hidden="true"></i></span>
                                        اضافة  جديد   </a>
                                </li>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-horizontal">
                                                    <div class="form-group">
                                                        <div class="col-md-12">
                                                            <input type="text" name="name" value="" class="form-control" placeholder="الخصم ">
                                                        </div>
                                                    </div>
                            ...
                            <div class="card-box text-left">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="box-tebal">
                                                <div class="title">
                                                    <h4><i class="fa fa-list" aria-hidden="true"></i>قائمه خصومات المناسبات     </h4>
                                                </div>
                                                    ...
                                                    <table class="datatable-buttons table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="/dashboard/event-discounts/{{$item->id}}/edit">
                                                                        <i class="fa fa-pencil  m-r-10" style="color: #188ae2;">
                                                                        </i> تعديل</a>
                                                                </td>

                                                                <td>
                                                                     <a href="{{route('event-discounts.destroy',$item)}}" id="delete-btn"  >
