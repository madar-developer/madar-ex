        ...
        <div class="" style="padding: 20px;direction: ltr;height: auto;" id="DivIdToPrint">
            <div class="row">
                <div class="col-md-12" style="">
                    <table class="table tab1 table11"
                        style="border: 0 !important; direction: rtl; text-align: right; width: 18rem; float: right;">
                        <tr>
                            <td style="border: 0 !important; width: 9rem; text-align: center;" colspan="2">

                                <img class="img-responsive" style="margin: auto;" src="{{ asset('/adminto/assets/images/logo.png')}}" width="250" height="100">
                            </td>
                        </tr>
                        <tr>
                            <td style="border: 0 !important;background-color: orange; width: 9rem; text-align: left;">
                                الاجمالي
                                <br />
                                Tolal
                            </td>
                ...
                <div class="col-md-6">
                    <table class="table" style="border-top: 0 !important;">
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="text-align:center;">{{$order->Company->email ?? ''}}</td>
                ...
                <div class="col-md-6">
                    ...
                    <table class="table" style="border-top: 0 !important;">
                        ...
                        <tr>
                            <td style="text-align: left;">City :</td>
                            <td colspan="5" style="text-align:center;">{{$order->City->Parent->name ?? ''}} / {{$order->City->name ?? ''}}</</td> <td
