...
@section('header')
<div class="add-btn">
    <a href="{{ url('/dashboard/region-areas/create') }}" type="button"
        class="btn btn-custom btn-rounded waves-effect waves-light w-md m-b-5">
        <i class="fa fa-check"></i> إضافة منطقة
    </a>
</div>
@endsection
@section('content')
            ...
            <table id="datatable-buttons" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="btns">
                            <a href="/dashboard/region-areas/{{ $item->id }}/edit"
                                class="btn btn-info waves-effect waves-light m-b-5 btn-xs">
                                <i class="fa fa-pencil"></i> تعديل
                            </a>
                            <a href="{{ route('region-areas.destroy', $item) }}" id="delete-btn"
