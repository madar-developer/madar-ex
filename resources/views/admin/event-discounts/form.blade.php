<div class="col-sm-12">
    <div class="card-box text-left">
        ...
        <!--     <h4 class="header-title header-title-custom m-t-0 m-b-30">بيانات خصومات المناسبات</h4>-->
            ...
            <div class="col-lg-12">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">       المناسبة :   </label>
                        <div class="col-md-9 ">
                            {!! Form::text("occasion",null,['class'=>'form-control', 'placeholder' => '  إسم  المناسبه 
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">      نص الإشعار  : </label>
                        <div class="col-md-9">
                            {!! Form::text("notification_text",null,['class'=>'form-control', 'placeholder' => "",
                            'required' => ''])!!}
                        </div>
                    </div>
