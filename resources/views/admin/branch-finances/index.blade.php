                                                    ...
                                                    <table id="datatable-buttons" class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            @php
                                                                $i=1;
                                                            @endphp
                                                            @foreach($branch_finances as $item)
                                                            ...
                                                            <tr>
                                                                <td>{{$i++}}</td>
                                                                  ...
                                                                  <td>
                                                                    @if($item->in_out == 'in')
                                                                    <div style="color: #10c469; font-weight: bold;">
                                                                        <i class="fa  fa-arrow-up"></i>
                                                                        داخل الي خزينة الشركه
                                                                    </div>
                                                                    @else
                                                                    <div style="color: #c4101f; font-weight: bold;">
                                                                        <i class="fa  fa-arrow-down"></i>
                                                                        خارج من خزينة الشركة
                                                                    </div>
                                                                    @endif
                                                                    </td>
                                                                {{-- <td class="btns">
