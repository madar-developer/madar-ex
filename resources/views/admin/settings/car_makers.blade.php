                    ...
                    <div class="col-md-12">
                                ...
                                <div class="panel panel-default margin-top-20">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group margin-top-15">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" name="name_ar" class="form-control" placeholder="أدخل الاسم هنا (AR)">
                                            </div>          
                                        </div>
                                        <div class="form-group margin-top-15">
                                            <label class="control-label col-md-3">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" name="name_en" class="form-control" placeholder="أدخل الاسم هنا (EN)">
                                            </div>          
                                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" style="overflow: hidden;">
                            <table class="datatable-buttons table table-striped table-bordered" style="width: 100%;">
                                ...
                                <tbody>
                                    @foreach(AllCarMakers() as $item )
                                    
                                    <tr>
                                        <td>{{$item->id}}</td>
                                        <td> {{$item->name_ar}} </td>
                                        <td> {{$item->name_en}} </td>
                                        <td> <a href="#" data-route="{{url('/dashboard/settings/car-makers-update/'.$item->id)}}" data-name_ar="{{ $item->name_ar }}" data-name_en="{{ $item->name_en }}" data-country="{{ $item->country }}" data-edulevel="{{ $item->edulevel }}" data-details="{{ $item->details }}" data-id="{{$item->id}}" class="edit"><i class="fa fa-pencil m-r-10" style="color: #5b69bc;"></i> تعديل</a></td>
                                        <td> 
                                            <a href="{{url('/dashboard/settings/car-makers-delete/'.$item->id)}}" id="delete-btn" ><i class="fa fa-trash-o m-r-10" style="color: #5b69bc;"></i> حذف</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
<script>
    ...
    $('#grant-button').on('click', function () {
    	...
    	$('input[name=edulevel]').attr('value', '');
    ...
    $(document).on('click', '.edit', function(e){
    	...
    	$('input[name=edulevel]').attr('value', $(this).attr('data-edulevel'));
