            ...
            <li>
                ...
                <div class="notification-box">
                    <ul class="list-inline m-b-0">
                        @php
                        $c_n =  \App\Models\Admin::first()->unreadnotifications->count();
                        @endphp
                        <li>
                            <a href="javascript:void(0);" class="right-bar-toggle"  style="position: relative; z-index:5000;">
                                <i class="fa fa-bell-o"></i>
                            </a>
                            <div class="noti-dot">
                                <span class="dot"></span>
                                <span class="pulse"></span>
                                <span id="noti-count" style="position: relative; font-size: 15px; background: red; height: 18px; padding: 0px 5px 2px 5px; border-radius: 50%; top: -15px; width: 17px; color: #fff; right: -15px;">{{$c_n}}</span>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <script>
        ...
        <script>
            ...
            channel.bind('general', function(data) {
                ...
                getNotification(data['link'], "{{ asset('/adminto/assets/images/logo.png')}}" , 'MadarExpress', data['message']);
