    ...
    <table class="table table-striped" style="  border: 1px solid gray;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="  border: 1px solid gray;">{{$driver->identity_image}}</td>
        ...
        <table id="datatable-buttons" class="table table-striped table-bordered">
            <thead>
                <tr>
                    ...
                    <th> طلبات تم التوصيل</th>
                    <th> طلبات تم الارجاع</th>
...
<div class="col-md-12">
    <div class="col-md-12 text-center" style="">
        <h3> طلبات تم تحصيلها من السائق  </h3>
      </div>
      <table class="table table-striped table-bordered">
        ...
        <tbody>
            @foreach($driver->Order()->where('status', 'delivered')->where('collected', 1)->get() as $item)
