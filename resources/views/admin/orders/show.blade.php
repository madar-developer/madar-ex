            ...
            <table class="table table-bordered" style=" border: 1px solid gray;">
                <thead>
                    <tr style=" border: 1px solid black;">
                        ...
                        <th style="text-align:right; border: 1px solid black;">بواسطة</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($order->OrderLog()->orderBy('id' ,'asc')->get() as $item)
                    <tr style=" border: 1px solid black;">
                        ...
                        <td style=" border: 1px solid black;">
                            @if ($item->added_by_type == 'driver')
                            السائق:
                            {{@\App\Models\Driver::where('id',$item->added_by_id)->first()->name}}
                              - {{@\App\Models\Driver::where('id',$item->added_by_id)->first()->phone}}
