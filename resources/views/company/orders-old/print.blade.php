            ...
            <div class="col-md-12 text-center" style="">
                ...
                <div class="col-md-6">
                    <table class="table" style="border-top: 0 !important;">
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="text-align:center;">{{$order->Company()->first()->name}}</td>
                            <td style="text-align: right;"> : اسم المرسل</td>
                        </tr>
                        <tr>
                            <td style="text-align: left;">Phone :</td>
                            <td colspan="5" style="text-align:center;">{{$order->Company()->first()->phone}}</td>
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="text-align:center;">{{$order->Company()->first()->City()->first()->name}}</td>
                            <td style="text-align: right;"> : المدينه</td>
                        </tr>
                        <tr>
                            <td style="text-align: left;">Adress :</td>
                            <td colspan="5" style="text-align:center;">{{$order->Company()->first()->adress_details}}</td>
                ...
                <div class="col-md-6">
                    ...
                    <table class="table" style="border-top: 0 !important;">
                        ...
                        <tr>
                            <td style="text-align: left;">City :</td>
                            <td colspan="5" style="text-align:center;">{{$order->City()->first()->name}}</</td>
                            <td style="text-align: right;"> : المدينه</td>
                        </tr>
                        <tr>
                            <td style="text-align: left;">Adress :</td>
