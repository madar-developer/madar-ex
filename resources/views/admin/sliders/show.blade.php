...
<div class="row">
    <div class="col-sm-12 m-b-15">
        <div class="btn-group pull-right m-t-15">
            <a href="/dashboard/sliders/"{{sliders->id}}/edit}}" class="btn btn-info waves-effect w-md waves-light m-b-5">
                <i class="fa fa-pencil m-r-5"></i>
                <span>تعديل</span>
            </a>

            <a href="{{route('users.destroy',slider)}}" id="delete-btn"
                                    ...
                                    <thead>
                                        <tr>
                                            <th colspan="2" class="text-center">
                                                <img src=" {{ slider->image }}" style="width: 100px; height: 100px;border-radius: 50%;border: 2px solid #2c0d0d;" />
                                            </th>
                                        </tr>
                                        <tr>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="datatable-buttons table tab-pane-custom table-striped table-bordered"
                                    ...
                                    <tbody>
                                        @foreach(slider->Order()->get() as $item)
                                        <tr>
                                            <td>{{$item->id}}</td>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                  <table class="datatable-buttons table tab-pane-custom table-striped table-bordered"  style="width: 100%;">
                                        ...
                                        <tbody>
                                            @foreach (slider->CompanyOrder()->get() as $item)
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <table class="table table-bordered table-striped text-center m-0">
                                    <thead>
                                        <th colspan="2" class="text-center">
                                            <img src="{{slider->BusinessAccount->image ?? ''}}" style="width: 100px; height: 100px;border-radius: 50%;border: 2px solid #e7cd10;" />
                                            <br>
                                            <i class="fa fa-star" aria-hidden="true"  style="color: gold"></i> 
                                            <i class="fa fa-star" aria-hidden="true"  style="color: gold"></i> 
                                            <i class="fa fa-star" aria-hidden="true"  style="color: gold"></i> 
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>البريد الالكتروني</td>
                                            <td>{{slider->BusinessAccount->email ?? ''}}</td>
                                        </tr>
                                        <tr>
                                            <td>اسم الشركة </td>
                                            <td>{{slider->BusinessAccount->company_name ?? ''}}</td>
                                        </tr>
                                        <tr>
                                            <td> السجل التجاري</td>
                                            <td>{{slider->BusinessAccount->registration_number ?? ''}}</td>
                                        </tr>
                                        <tr>
                                            <td> رقم الجوال </td>
                                            <td>{{slider->BusinessAccount->phone ?? ''}}</td>
                                        </tr>
                                        {{-- <tr>
                                            <td> الصوره </td>
                                            <td> 
                                                <img src="{{slider->BusinessAccount->image ?? ''}}" width="300px"
                                                    height="300px"> 
                                                </td>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table class="datatable-buttons table tab-pane-custom table-striped table-bordered"
                                    ...
                                    {{--  ///////////////////////////////////////////////////////////////////  --}}
                                    <tbody>
                                        @foreach (slider->Favourite()->get() as $item)
                                        {{--  $item = slider->Favourite()->first()  --}}
