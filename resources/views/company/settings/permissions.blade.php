                                            ...
                                            <div class="row">
                                                ...
                                                <div class="content" style="padding: 15px;">
                                                    ...
                                                    <div class=" col-md-6">
                                                        <div class=" action-master-wrapper with-height">
                                                            ...
                                                            <div class="action-inner action-inner-frist">
                                                                ...
                                                                <label for="1">{{__('words.permission_'.$model)}}</label>
                                                            </div>
                                                    ...
                                                    <div class=" col-md-4">
                                                        <div class=" action-master-wrapper-alone">
                                                            <div class="action-inner">
                                                                <input value="41" class="selecctall" id="41" type="checkbox" name="transaction_show">
                                                                <label for="41"> التحويلات المالية </label>
                                                            </div>
                                                        </div>
                                                    </div>
