                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="title-page sub-header-title-custom">
                            <h5 style="color: inherit;"><a href="#"><span> الخصومات </span><i class="fa fa-angle-left" style="padding: 0 5px; color:inherit;"></i></a><span>نطره عامة        </span></h5>

                            <ul>


                                <li class="offer-2">
                                    <a href="{{url('/dashboard/discounts/create')}}"><span><i class="fa fa-plus" aria-hidden="true"></i></span>
                                        اضافة  جديد   </a>
                                </li>
                            ...
                            <div class="card-box text-left">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="box-tebal">
                                                <div class="title">
                                                    <h4><i class="fa fa-list" aria-hidden="true"></i>قائمه الخصومات     </h4>
                                                </div>
                                                    ...
                                                    <table class="datatable-buttons table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                     <a href="{{route('discounts.destroy',$item)}}" id="delete-btn"  >
