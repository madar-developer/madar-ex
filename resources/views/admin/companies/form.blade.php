            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label class="">تكلفه الدفع عند الاستلام *</label>
                            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="">
                                {!! Form::number("inside_payment_method",null,['class'=>"form-control select2
                                ",
                                "autocomplete"=>
                                'off', 'id' => 'banks'])!!}
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class=""> الدفع عند الاستلام *</label>
                            <div class="">
                                {!! Form::number("outside_payment_method",null,['class'=>"form-control select2
                                ",
                                "autocomplete"=>
                                'off', 'id' => 'banks', 'style' =>" display: inline-block;"])!!}
                            </div>
